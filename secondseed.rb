...
Organization.create(name:"Courage House",
 ...
 fee: "None")
ProvidedService.create(organization_id: 9, support_system: true, housing: true, support_system: true)
Language.create(organization_id: 9)
Gender.create(organization_id: 9, male: false, female: true, trans_female: false, trans_male: false)
...
Organization.create(name:"Freedom House",
 ...
 service_hour:
 fee: "None")
ProvidedService.create(organization_id: 10,  housing: true, support_system: true)
Language.create(organization_id: 10)
Gender.create(organization_id: 10, male: false, female: true, trans_female: false, trans_male: false)
...
Organization.create(name:"Freedom House -- the Nest",
 ...
 fee: "None")
ProvidedService.create(organization_id: 11, support_system: true, education: true,)
Language.create(organization_id: 11, spanish: true, russian: true, korean: true)
...
ProvidedService.create(organization_id: 12, support_system: true, education: true, employment: true, language: true)
Language.create(organization_id: 12, cantonese: true, mandarin: true, vietnamese: true)
...
ProvidedService.create(organization_id: 13, support_system: true, legal: true)
...
Organization.create(name:"La Casa de Las Madres",
 ...
 fee: "None")
PhoneNumber.create(organization_id: 14, main_number: "(415) 503-0500", emergency_number: "(877) 503-1850")
ProvidedService.create(organization_id: 14, housing: true, support_system: true, legal: true, )
Language.create(organization_id: 14, cantonese: true, farsi: true, french: true, german: true, hebrew: true, italian: true, korean: true, macedonian: true, mandarin: true, portuguese: true, serbo_croat: true, tagalong: true, taishanese: true)
Gender.create(organization_id: 14,female: true, male: true, trans_female: true, trans_male: true)
Age.create(organization_id: 14, maximum_age: 100, minimum_age: 0)
